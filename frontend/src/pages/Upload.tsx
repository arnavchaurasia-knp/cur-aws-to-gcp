        ...
        <main className="flex flex-col gap-6">
          ...
          <div className="flex flex-col gap-2">
            ...
            <input value={prospect} onChange={e => setProspect(e.target.value)}
              ...
              className="bg-white/5 border border-white/20 rounded-lg px-4 py-2 text-sm outline-none focus:border-[#645DF6]" />
          </div>
          <div className="flex flex-col gap-2">
            <label className="text-xs uppercase tracking-wider text-gray-400">AWS bill — CUR, Cost Explorer export, or console PDF</label>
            <DropZone file={file} onChange={setFile} />
          </div>
          <button onClick={submit} disabled={!file || !prospect.trim() || submitting}
          ...
          <section className="mt-4 grid gap-6 md:grid-cols-2">
            ...
            <div className="bg-white/[0.02] border border-white/10 rounded-lg p-5">
              ...
              <p className="text-sm text-gray-300 mb-3">
                An AI agent works through six phases on your bill — typically 10–30 minutes total.
              </p>
              <ol className="text-xs text-gray-400 space-y-1.5">
                <li><span className="text-gray-200 font-mono mr-2">1.</span>Ingestion — load &amp; classify line items</li>
                <li><span className="text-gray-200 font-mono mr-2">2.</span>Mapping — AWS service → GCP equivalent</li>
                <li><span className="text-gray-200 font-mono mr-2">3.</span>Review — sanity-check the mappings</li>
                <li><span className="text-gray-200 font-mono mr-2">4.</span>Rate fill — on-demand &amp; CUD pricing</li>
                <li><span className="text-gray-200 font-mono mr-2">5.</span>Outlier triage — investigate anomalies</li>
                <li><span className="text-gray-200 font-mono mr-2">6.</span>Report — render the HTML deliverable</li>
              </ol>
            </div>
          </section>
