...
echo ">> Syncing skill to ${HOME}/.gemini/skills/aws-gcp-cost-projection"
mkdir -p "$HOME/.gemini/skills/aws-gcp-cost-projection"
rsync -a --delete aws-gcp-cost-projection/ "$HOME/.gemini/skills/aws-gcp-cost-projection/"
