...
echo ">> Syncing skill to ${HOME}/.claude/skills/aws-gcp-cost-projection"
mkdir -p "$HOME/.claude/skills/aws-gcp-cost-projection"
rsync -a --delete aws-gcp-cost-projection/ "$HOME/.claude/skills/aws-gcp-cost-projection/"
